...
class Cust_Win:
    def __init__(self,root):
        ...
        self.root.geometry("1910x1000+230+220")
        ...
        entry_ref=ttk.Entry(labelframeleft,textvariable=self.var_ref,width=29,font=("arial",10),state="readonly")
        entry_ref.grid(row=0,column=1)
        #cust name
        cname = Label(labelframeleft, text="Customer Name ", font=("arial", 12,"bold"), padx=2, pady=6)
        cname.grid(row=1, column=0, sticky=W)

        txtcname = ttk.Entry(labelframeleft,textvariable=self.var_cust_name, width=29, font=("arial", 10))
        ...
        txtmname = ttk.Entry(labelframeleft,textvariable=self.var_mother, width=29, font=("arial", 10))
        ...
        combo_gender = ttk.Combobox(labelframeleft,textvariable=self.var_gender, width=29, font=("arial", 10),state="readonly")
        ...
        txtPostCode = ttk.Entry(labelframeleft,textvariable=self.var_post, width=29, font=("arial", 10))
        ...
        txtMobile = ttk.Entry(labelframeleft,textvariable=self.var_mobile, width=29, font=("arial", 10))
        txtMobile.grid(row=5, column=1)
        # email
        lblEmail=Label(labelframeleft, text="E-mail id ", font=("arial", 12, "bold"), padx=2, pady=6)
        lblEmail.grid(row=6, column=0, sticky=W)

        txtEmail = ttk.Entry(labelframeleft,textvariable=self.var_email, width=29, font=("arial", 10))
        ...
        combo_Nationality = ttk.Combobox(labelframeleft,textvariable=self.var_nationality, width=29, font=("arial", 10),state="readonly")
        ...
        combo_IdProof = ttk.Combobox(labelframeleft,textvariable=self.var_id_proof, width=29, font=("arial", 10), state="readonly")
        ...
        txtIdNumber = ttk.Entry(labelframeleft,textvariable=self.var_id_number, width=29, font=("arial", 10))
        ...
        txtAddress = ttk.Entry(labelframeleft,textvariable=self.var_address, width=29, font=("arial", 10))
        txtAddress.grid(row=10, column=1)

        #======btns=====
        btn_frame=Frame(labelframeleft,bd=2,relief=RIDGE)
        btn_frame.place(x=10,y=550,width=500,height=45)
        ...
        Table_Frame.place(x=650, y=90, width=1210, height=700)
        ...
        details_table.place(x=5, y=50, width=1200, height=600)

        scroll_x=ttk.Scrollbar(details_table,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(details_table,orient=VERTICAL)

        self.Cust_Details_Table=ttk.Treeview(details_table,column=("ref","name","mother","gender","post","mobile","email","nationality","id proof","id number","address"), xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
        if self.var_mobile.get()=="" or self.var_mother.get()=="":
            ...
            try:
               conn=mysql.connector.connect(host="localhost",username="root",password="ducat123",database="project")
    ...
    def search(self):
        ...
        my_cursor.execute("select * from customer where "+str(self.search_var.get())+"LIKE'%"+str(self.txt_search.get())+"%s'")
        rows=my_cursor.fetchall()
        if len (rows)!=0:
            self.Cust_Details_Table.delete(*self.Cust_Details_Table.get_children())
            for i in rows:
