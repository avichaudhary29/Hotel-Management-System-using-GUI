...
class Register:
    def __init__(self,root):
        ...
        #=================bg image==============
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Avi Chaudhary\Desktop\Hotel management(GUI)\background.jpg")
        bg_lbl=Label(self.root,image=self.bg)
        bg_lbl.place(x=0,y=0,relwidth=1,relheight=1)


        # ==============left image==================
        self.bg1 = ImageTk.PhotoImage(file=r"C:\Users\Avi Chaudhary\Desktop\Hotel management(GUI)\regis.jpg")
        ...
        self.combo_security_Q["values"] = ("Select", "Your Birth Place", "You Pet Name", "Your School name")
        self.combo_security_Q.place(x=50, y=270, width=250)
        self.combo_security_Q.current(0)

        security_A = Label(frame, textvariable=self.var_SecurityA, text="Security Answer",font=("times new roman", 15, "bold"), bg="white", fg="black")
        ...
        #========================buttons======
        img=Image.open(r"C:\Users\Avi Chaudhary\Desktop\Hotel management(GUI)\register.jpg")
        ...
        b1.place(x=45,y=450,width=200)

        img1 = Image.open(r"C:\Users\Avi Chaudhary\Desktop\Hotel management(GUI)\loginregister.jpg")
        ...
        b1.place(x=390, y=450, width=200)
